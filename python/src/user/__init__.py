...
class User:
    ...
    @classmethod
    def from_json_data(cls, data: Any) -> 'User':
        return cls(
            _from_json_data(datetime, data.get("createdAt")),
            _from_json_data(str, data.get("id")),
            _from_json_data(bool, data.get("isAdmin")),
            _from_json_data(int, data.get("karma")),
        )

    def to_json_data(self) -> Any:
        data: Dict[str, Any] = {}
        data["createdAt"] = _to_json_data(self.created_at)
        data["id"] = _to_json_data(self.id)
        data["isAdmin"] = _to_json_data(self.is_admin)
        data["karma"] = _to_json_data(self.karma)
        return data
